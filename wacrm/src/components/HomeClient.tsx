  ...
  return (
    <div className="flex-1 overflow-auto">
      <div className="p-8 max-w-7xl">
        ...
        {/* Onboarding Checklist - only for new workspace owners */}
        {data.onboarding && (
          <OnboardingChecklist
            hasContacts={data.onboarding.hasContacts}
            hasInvoices={data.onboarding.hasInvoices}
            hasTeamMembers={data.onboarding.hasTeamMembers}
